...
import com.kali.shared.termux.terminal.io.BellHandler;
import com.kali.shared.logger.Logger;
import com.kali.terminal.TerminalColors;
import com.kali.terminal.TerminalSession;
import com.kali.terminal.TerminalSessionClient;
import com.kali.terminal.TextStyle;
...
public class TermuxTerminalSessionActivityClient extends TermuxTerminalSessionClientBase {
    ...
    private synchronized void loadBellSoundPool() {
        if (mBellSoundPool == null) {
            ...
            try {
                mBellSoundId = mBellSoundPool.load(mActivity, com.kali.shared.R.raw.bell, 1);
            } catch (Exception e){
                // Catch java.lang.RuntimeException: Unable to resume activity {com.kali/com.kali.app.TermuxActivity}: android.content.res.Resources$NotFoundException: File res/raw/bell.ogg from drawable resource ID
