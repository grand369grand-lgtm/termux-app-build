package com.kali.shared.activities;
...
import com.kali.shared.file.filesystem.FileType;
 ...
 * {@code `<activity android:name="com.kali.shared.activities.ReportActivity" android:theme="@style/Theme.AppCompat.TermuxReportActivity" android:documentLaunchMode="intoExisting" />` }
 * and
 * {@code `<receiver android:name="com.kali.shared.activities.ReportActivity$ReportActivityBroadcastReceiver"  android:exported="false" />` }
