...
import com.kali.R;
import com.kali.app.event.SystemEventReceiver;
import com.kali.app.terminal.TermuxTerminalSessionActivityClient;
import com.kali.app.terminal.TermuxTerminalSessionServiceClient;
import com.kali.shared.termux.plugins.TermuxPluginUtils;
import com.kali.shared.data.IntentUtils;
import com.kali.shared.net.uri.UriUtils;
import com.kali.shared.errors.Errno;
import com.kali.shared.shell.ShellUtils;
import com.kali.shared.shell.command.runner.app.AppShell;
import com.kali.shared.termux.settings.properties.TermuxAppSharedProperties;
import com.kali.shared.termux.shell.command.environment.TermuxShellEnvironment;
import com.kali.shared.termux.shell.TermuxShellUtils;
import com.kali.shared.termux.TermuxConstants;
import com.kali.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_ACTIVITY;
import com.kali.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_SERVICE;
import com.kali.shared.termux.settings.preferences.TermuxAppSharedPreferences;
import com.kali.shared.termux.shell.TermuxShellManager;
...
import com.kali.shared.notification.NotificationUtils;
...
import com.kali.shared.shell.command.ExecutionCommand.ShellCreateMode;
import com.kali.terminal.TerminalEmulator;
    ...
    private synchronized void killAllTermuxExecutionCommands() {
        ...
        for (int i = 0; i < pendingPluginExecutionCommands.size(); i++) {
            ...
            if (!executionCommand.shouldNotProcessResults() && executionCommand.isPluginExecutionCommandWithPendingResult()) {
                if (executionCommand.setStateFailed(Errno.ERRNO_CANCELLED.getCode(), this.getString(com.kali.shared.R.string.error_execution_cancelled))) {
